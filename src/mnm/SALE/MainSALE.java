    ...
    private void init() {
        ...
        menu.addEventShowPopup(new EventShowPopupMenu() {
            ...
            public void showPopup(Component com) {
                ...
                PopupMenu popup = new PopupMenu(MainSALE.this, item.getIndex(), item.getEventSelected(), item.getMenu().getSubMenu());
                int x = MainSALE.this.getX() + 52;
                int y = MainSALE.this.getY() + com.getY() + 86;
