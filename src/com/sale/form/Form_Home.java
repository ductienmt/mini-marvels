...
public class Form_Home extends javax.swing.JPanel {
    ...
    public Form_Home() {
        initComponents();
//        jScrollPane1.setPreferredSize(jPanel2.getPreferredSize());
    ...
    private void initCardData() {
        ...
        card1.setData(new ModelCard("New Student", 5100, 20, icon3));
        ...
        card3.setData(new ModelCard("Expense", 3000, 80, icon1));
    ...
    private boolean showMessage(String message) {
        Message obj = new Message(MainSALE.getFrames()[0], true);
