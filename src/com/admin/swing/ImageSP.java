...
public class ImageSP extends JComponent {
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        if (icon != null) {
            ...
            int rectWidth = width - border;
            int rectHeight = height - border;
            ...
            if (borderSize > 0) {
                g2.setColor(getForeground());
                g2.fillRect(x, y, width - borderSize, height - borderSize);
            }

            if (isOpaque()) {
                g2.setColor(getBackground());
                g2.fillRect(x + borderSize, y + borderSize, rectWidth, rectHeight);
            }

            // Vẽ biểu tượng
            g2.drawImage(toImage(icon), x + borderSize, y + borderSize, rectWidth, rectHeight, null);
        }
        super.paintComponent(grphcs);
    }
