...
import com.admin.swing.ButtonCustom;
import com.admin.swing.MenuItem;
...
public class Menu extends javax.swing.JPanel {
    ...
    public void setEvent(EventMenuSelectedForm event) {
        this.event = event;
    }
    ...
    private EventMenuSelectedForm event;
    ...
    public void addMenu(ModelMenu menu) {
        ...
        item.addEvent(new EventMenuSelectedForm() {
            @Override
    ...
    private void createButtonMenu() {
        ...
        cmdMenu.setIcon(new ImageIcon(getClass().getResource("/com/admin/icon/menu.png")));
    ...
    private void createButtonLogout() {
        ...
        cmdLogOut.setIcon(new ImageIcon(getClass().getResource("/com/admin/icon/exit.png")));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra = new GradientPaint(0, 0, Color.decode("#9d99ff"), 0, getHeight(), Color.decode("#2F80ED"));
        g2.setPaint(gra);
